...
// Get a common factor between all the divisibleBy, so we can prevent our worry levels int overflowing
const globalMod = monkeys.reduce((acc, b) => acc * b.test.divisibleBy, 1);

// Go through 10000 rounds
Array(10000)
    .fill(null)
    .forEach(() => {
        monkeys.forEach((monkey) => {
            ...
            itemsCopy.forEach((worryLevel) => {
                ...
                newWorryLevel = newWorryLevel % globalMod;
